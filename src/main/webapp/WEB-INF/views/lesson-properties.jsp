    ...
    function get(lessonId) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                // document.getElementById('tutorial_ud').value = t;
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <button style="float: right" type="button" class="btn btn-success btn-sm"
                                    data-toggle="modal"
                                    data-target="#myModal" onclick="get(${id})"><i class="fa fa-pencil"></i> &nbsp;Sửa
                            </button>
                            <a href="/del?id=${id}" onclick="return confirm('Bạn có muốn xóa không?')">
                                <button style="float: right" type="button" class="btn btn-success btn-sm"><i
                        ...
                        <div class="card-body">
                            ...
                            <div style="margin: auto">
                                <b style="float: left"><label for="tutorials">Nội dung:&nbsp;</label></b>
                                <div class="left">
                                    <p style="float: left" id="tutorials">${lesson.tutorial}</p>
                                </div>
                            </div>
                        </div>
                    </div>
